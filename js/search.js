$(function () {
    ...
    function interest(index) {
        ...
        $.ajax({
            url: 'https://api.jisuapi.com/news/search?keyword=' + type + '&appkey=fe2a29e929bf5cc5',
            dataType: "jsonp",
            beforeSend:function () {
                $(".shade").show();
                $("#button").hide();
            ...
            success: function (val) {
                ...
                newarr.forEach(function (val, ind) {
                    ...
                    if (!val.pic) {
                        ...
                        str += `<li class="mark"><a href="details.html">
                                <div class="left">
                                    <div class="leftBox">
                                        <img src="${val.pic}" alt="">
                                    </div>
    ...
    $(".content").on("click","p",function () {
        ...
        $("#main").html("");
        $.ajax({
            url: 'https://api.jisuapi.com/news/search?keyword=' + val + '&appkey=fe2a29e929bf5cc5',
            dataType: "jsonp",
            beforeSend:function () {
                $(".shade").show();
                $("#button").hide();
